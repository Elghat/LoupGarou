...
//	SOCKADDR_IN Csin;
//
//	sin.sin_addr.s_addr = INADDR_ANY; //d�finit l'adresse du serveur (any = toute mes interfaces)
...
//
//	while (!gagnant) {
//		printf("les villageois s'endorment");//envoyer � tous les joueurs
//		tourLoup();
//		printf("les villageois se reveillent");//envoyer � tous les joueurs
//		tourVillage();
//	}
//	
//
